...
<div className="mb-4"><p className="text-primary font-semibold tracking-[.22em] uppercase text-xs mb-3">Code • Learn • Build</p><h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-2">Hi, I'm</h1>
  
  {/* <div className="hidden dark:block"><AuroraTextEffect text="Nambari Sai Sravya" fontSize="clamp(3rem, 6.5vw, 5.5rem)" className="bg-transparent overflow-visible p-0 justify-start" textClassName="bg-gradient-to-r from-cyan-400 via-purple-400 to-sky-300 bg-clip-text text-transparent pb-2 font-extrabold"/>
  ...
  <div>
    <span className="block text-[clamp(3rem,6.5vw,5.5rem)] leading-[0.95] tracking-tight font-extrabold">
      <span className="block bg-gradient-to-r from-cyan-400 via-purple-400 to-sky-300 bg-clip-text text-transparent">
        Nambari
      </span>
  ...
  <div className="block dark:hidden"><span className="bg-gradient-to-r from-violet-600 via-sky-500 to-purple-600 bg-clip-text text-transparent font-extrabold text-[clamp(3rem,6.5vw,5.5rem)] leading-none tracking-tight block pb-2">Nambari Sai Sravya</span></div></div>
